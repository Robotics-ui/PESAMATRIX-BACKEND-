...
exports.getSubscriptionStats = exports.getDashboardStats = void 0;
...
const getDashboardStats = async (req, res) => {
    try {
        ...
        const historyDeals = historyStorage.getDealsByTimeRange(new Date(Date.now() - 30 * 24 * 60 * 60 * 1000), new Date());
        let totalProfit = 0;
        let winningTrades = 0;
        let losingTrades = 0;
        let grossProfit = 0;
